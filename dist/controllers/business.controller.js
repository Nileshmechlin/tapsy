...
const updateBusinessDetails = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId } = req.params;
        const details = req.body;
        const updated = yield businessService.updateBusinessDetails(userId, details);
